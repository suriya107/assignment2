...
function calculateTotal() {
    ...
    const product1Price = 200; 
    const product2Price = 200;
    const product3Price = 100;
    ...
    const totalBill = product1Quantity * product1Price + product2Quantity * product2Price + product3Quantity * product3Price;
